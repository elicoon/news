...
@referenced_temperature=forecast["daily"]["data"] #note that this needs a loop to actually define which day we want, plus ["temperature"]
@referenced_summary=forecast["daily"]["data"] #note that this needs a loop to actually define which day we want ["summary"]
